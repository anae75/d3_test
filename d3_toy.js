...
// XXX zero-weight nodes wreak havoc on parition!!!
function clean(dataset)
{
  dataset.lookup = {};
  var stack = [];
  stack.push(dataset.root);
  var counter = 0;
...
tree_data = '{"name":"Template","children":[{"name":"Non-Investment Cash","children":[],"size":0.6},{"name":"Uncategorized Holdings not in Targets","children":[{"name":"Uncategorized Holdings not in Targets","children":[{"name":"Uncategorized Holdings not in Targets","children":[],"size":25.78}],"size":25.78}],"size":25.78},{"name":"Cash","children":[{"name":"Cash","children":[{"name":"CASH [$$$$$$]","children":[],"size":0.59}],"size":0.59}],"size":0.59},{"name":"Domestic Equitites","children":[{"name":"Large Cap","children":[{"name":"Large Cap Growth","children":[{"name":"LCG-RiverPark/Wedgewood Fund [RWGIX]","children":[],"size":0}],"size":0},{"name":"Large Cap Value","children":[{"name":"LCV-Sterling Capital Equity Income Fund [BEGIX]","children":[],"size":12.14}],"size":12.14}],"size":12.14},{"name":"Mid and Small","children":[{"name":"Mid Cap Growth","children":[{"name":"MCG-Goldman Sachs Growth Opportunities [GGOIX]","children":[],"size":6.7}],"size":6.7},{"name":"Mid Cap Value","children":[{"name":"MCV-Artisan Mid Cap Value [ARTQX]","children":[],"size":7.56}],"size":7.56},{"name":"Small Cap Growth","children":[{"name":"SCG-Eagle Small Cap Growth Fund [HSIIX]","children":[],"size":0}],"size":0},{"name":"Small Cap Value","children":[{"name":"SCV-Northern Small Cap Value [NOSGX]","children":[],"size":0}],"size":0}],"size":14.25}],"size":26.4},{"name":"International Developed Equities","children":[{"name":"International Growth","children":[{"name":"IntlG-Harding Loevner International Equity Institutional [HLMIX]","children":[],"size":12.94}],"size":12.94},{"name":"International Value","children":[{"name":"IntlV-Harbor International [HAINX]","children":[],"size":14.01}],"size":14.01}],"size":26.95},{"name":"Emerging Markets and Internatl Small Cap","children":[{"name":"Emerging Markets","children":[{"name":"EMkts-Oppenheimer Developing Markets Fund [ODVYX]","children":[],"size":11.4},{"name":"EMkts-Lazard Emerging Markets Equity [LZEMX]","children":[],"size":0}],"size":11.4}],"size":11.4},{"name":"Diversifying Assets","children":[{"name":"Commodities","children":[{"name":"Commodity","children":[{"name":"Com-PIMCO Commodity Real Return Strategy [PCRIX]","children":[],"size":4.12}],"size":4.12}],"size":4.12},{"name":"REITs","children":[{"name":"REIT","children":[{"name":"REIT-iShares Dow Jones U.S. Real Estate [IYR]","children":[],"size":4.16}],"size":4.16}],"size":4.16}],"size":8.28}]}';
